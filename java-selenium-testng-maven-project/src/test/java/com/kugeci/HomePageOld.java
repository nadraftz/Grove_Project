...
//	    byte[] expectedTitle = "é…·æ­Œè¯�".getBytes("US-ASCII");
...
//		byte[] expectedString = "æ�œæ�œ".getBytes("US-ASCII");
...
//		
//		byte[] expectedBytes = "æ—¥æœ¬èªžç‰ˆ".getBytes("US-ASCII");	        
...
//		byte[] expectedBytes1 = "é¦–é¡µ".getBytes("US-ASCII");
...
//		
//		byte[] expectedBytes2 = "ä»Šæ—¥çƒ­é—¨æ­Œæ›²".getBytes("US-ASCII");
...
//		
//		byte[] expectedBytes3 = "çƒ­é—¨æ­Œæ›²".getBytes("US-ASCII");
...
//		
//		byte[] expectedBytes4 = "æœ€æ–°æ­Œæ›²".getBytes("US-ASCII");
...
//		
//		byte[] expectedBytes5 = "æ­Œæ‰‹".getBytes("US-ASCII");
...
//		
//		byte[] expectedBytes6 = "ä½œè¯�".getBytes("US-ASCII");
...
//		
//		byte[] expectedBytes7 = "ä½œæ›²".getBytes("US-ASCII");
...
//		byte[] expectedBytes1 = "ä»Šæ—¥çƒ­é—¨æ­Œæ›²".getBytes("US-ASCII");	        
...
//	
//		byte[] expectedBytes2 = "ä»Šæ—¥æœ€æ–°æ­Œæ›²".getBytes("US-ASCII");
...
//	
//		byte[] expectedBytes3 = "æœ€æ–°è§†é¢‘".getBytes("US-ASCII");	        
...
//		
//		byte[] expectedBytes4 = "çƒ­é—¨æ­Œæ‰‹".getBytes("US-ASCII");	 
//		// cssSelector generated by Ranorex Selocity
...
//
//		byte[] expectedBytes5 = "çƒ­é—¨ä½œè¯�".getBytes("US-ASCII");
...
//							
//		byte[] expectedBytes6 = "çƒ­é—¨ä½œæ›²".getBytes("US-ASCII");
